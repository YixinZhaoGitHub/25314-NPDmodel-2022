...
%
function [t,y,p]=sensifuction(aimname,aim)
...
p.NB=30; % Nutrient concentration at bottom     mmol N/m3     30
...
function dydt = derivative(t, y, p) 
   ...
   %reaction
           ...
           % light
             I = calculatelight(P,D,t,p,false); % constant environmental conditions
           % P growth rate
